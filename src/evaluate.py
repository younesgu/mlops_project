...
def evaluate(model_dir: str, data_dir: str, output_dir: str, min_accuracy: float = 0.85) -> dict:
...
def main() -> None:
    ...
    evaluate(args.model_dir, args.data_dir, args.output_dir, args.min_accuracy)
